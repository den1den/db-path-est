...
public class AdjacencyListTestOnMusic {
    ...
    public void testShortQuery() throws IOException {
        Collection<NodePair> nodes = list.solvePathQuery(Main.translateTextQueryToDomainQuery("+ 3", parser));
    ...
    public void testShortQuery_2() throws IOException {
        Collection<NodePair> nodes = list.solvePathQuery(Main.translateTextQueryToDomainQuery("+ 2 + 2", parser));
    ...
    public void testShortQuery_3() throws IOException {
        Collection<NodePair> nodes = list.solvePathQuery(Main.translateTextQueryToDomainQuery("+ 4 - 3", parser));
    ...
    public void testShortQuery_4() throws IOException {
        Collection<NodePair> nodes = list.solvePathQuery(Main.translateTextQueryToDomainQuery("- 6 - 2 - 2", parser));
    ...
    public void testLongerPathQuery() throws IOException {
        Collection<NodePair> nodes = list.solvePathQuery(Main.translateTextQueryToDomainQuery("+ 5 - 5 - 2", parser));
    ...
    public void testLongTimePathQuery() throws IOException {
        Collection<NodePair> nodes = list.solvePathQuery(new int[]{1, 7, 4});
    ...
    public void testLongTimePathQuery_2() throws IOException {
        Collection<NodePair> nodes = list.solvePathQuery(new int[]{1, 7, 4, 11});
